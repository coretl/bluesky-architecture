...
That matters here because of [](../decisions/0008-validation-state-is-owned-by-the-queue.md),
and working out what it would take in either system is not attempted on this
page.

## What this does not cover

- **`daq-queuing-service`** — DLS's own queuing service, which ADR-0008 names as
